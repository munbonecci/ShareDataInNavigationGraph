<h1 align="center">ShareDataInNavigationGraph</h1> 

<p align="center">
This app was created to learn more about Android compose using Navigation to share data using arguments 
between screens
</p>
...
```bash
git clone https://github.com/munbonecci/ShareDataInNavigationGraph.git
```
